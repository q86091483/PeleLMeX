  ...
  if ( amrex::ParallelDescriptor::MyProc() == 0) {
      ...
      */
      ...
      for (int inj = 0; inj < 7; ++inj) {
          ...
          if ( prob_parm.part_dia_saved[inj] > 0.0 ) { 
          ...
          while (total_mass < injection_mass) {
              ...
              // Get a particle size
              Real cur_dia = 0.0;
              if ( prob_parm.part_dia_saved[inj] > 0.0 ) { // We have a stored particles, use it (already checked that we can use it)
